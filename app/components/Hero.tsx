            ...
            <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                <div className="animate-fade-in">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-10">
                        <a
                            href="#courses"
                            className="px-6 py-3 bg-primary text-white rounded-lg font-bold flex items-center justify-center gap-2 hover:bg-primary-dark transition-all shadow-md shadow-primary/20 text-sm"
                        >
                            Explore Courses <ArrowRight className="w-4 h-4" />
                        </a>
                        <a
                            href="#about"
                            className="px-6 py-3 border border-slate-200 dark:border-slate-800 hover:border-primary/40 rounded-lg font-bold flex items-center justify-center transition-all text-sm text-slate-700 dark:text-slate-300"
                        >
                            Learn More
                        </a>
                    </div>
